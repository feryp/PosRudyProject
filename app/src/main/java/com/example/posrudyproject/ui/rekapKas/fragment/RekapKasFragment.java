        ...
        call.enqueue(new Callback<Map>() {
            ...
            public void onResponse(Call<Map> call, Response<Map> response) {
                if (!response.isSuccessful()){
                    ...
                    totalHarian.setText("Rp"+ df.format(Double.valueOf(Mon.get("total").toString()) + Float.parseFloat(Tue.get("total").toString()) + Float.parseFloat(Wed.get("total").toString()) + Float.parseFloat(Thu.get("total").toString()) + Float.parseFloat(Fri.get("total").toString()) + Float.parseFloat(Sat.get("total").toString()) + Float.parseFloat(Sun.get("total").toString())));
                    ...
                    totalMingguan.setText("Rp"+ df.format(Double.valueOf(week1.get("total").toString()) + Float.parseFloat(week2.get("total").toString()) + Float.parseFloat(week3.get("total").toString()) + Float.parseFloat(week4.get("total").toString())));
                    ...
                    totalBulanan.setText("Rp"+ df.format(Double.valueOf(Jan.get("total").toString()) +Float.parseFloat(Feb.get("total").toString())+Float.parseFloat(Mar.get("total").toString())+Float.parseFloat(Apr.get("total").toString())+Float.parseFloat(Mei.get("total").toString())+Float.parseFloat(Jun.get("total").toString())+Float.parseFloat(Jul.get("total").toString())+Float.parseFloat(Agt.get("total").toString())+Float.parseFloat(Sep.get("total").toString())+Float.parseFloat(Oct.get("total").toString())+Float.parseFloat(Nov.get("total").toString())+Float.parseFloat(Dec.get("total").toString())));
