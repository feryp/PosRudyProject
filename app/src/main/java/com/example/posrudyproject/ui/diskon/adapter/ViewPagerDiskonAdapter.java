...
public class ViewPagerDiskonAdapter extends FragmentStateAdapter {

    public final List<Fragment> mFragmentList = new ArrayList<>();
    public final List<String> mFragmentTitleList = new ArrayList<>();

    public ViewPagerDiskonAdapter(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
