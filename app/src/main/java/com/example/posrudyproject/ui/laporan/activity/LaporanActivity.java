    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.menu_penjualan_kategori_laporan:
                ...
                break;
            case R.id.menu_penjualan_tipe_laporan:
                Intent penjualanTipe = new Intent(this, PenjualanPerTipeActivity.class);
                startActivity(penjualanTipe);
                break;
            ...
            case R.id.menu_pelanggan_laporan:
                ...
                break;
            case R.id.menu_penjual_laporan:
                Intent penjual = new Intent(this, LaporanPenjualActivity.class);
